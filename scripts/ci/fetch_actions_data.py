...
Options:
    ...
    --repo OWNER/NAME   Repository (default: deepakdgupta1/zeroclaw)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="deepakdgupta1/zeroclaw",
        help="Repository in OWNER/NAME format (default: deepakdgupta1/zeroclaw)",
    )
