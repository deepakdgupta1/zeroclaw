...
const repoBase = "https://github.com/deepakdgupta1/zeroclaw/blob/main";
const rawBase = "https://raw.githubusercontent.com/deepakdgupta1/zeroclaw/main";
...
function normalizeManifestDoc(doc: ManifestDocRaw): ManifestDoc {
    ...
    return {
        ...
        readingMinutes:
            ...
            Number.isFinite(doc.readingMinutes)
...
const copy = {
    en: {
        ...
        notice: "Official source channels: use this repository as the source of truth and zeroclawlabs.ai as the official website.",
        ...
        noStartHere:
            "No starter docs matched the current language/filter context.",
        startBadge: "Starter",
    ...
    zh: {
        ...
        summary:
            "Fast, small, and fully autonomous AI assistant infrastructure.",
        summary2: "Deploy anywhere. Swap anything.",
        notice: "官方信息渠道：请以本仓库为事实来源，以 zeroclawlabs.ai 为官方网站。",
        ctaDocs: "立即阅读文档",
        ctaBootstrap: "一键安装",
...
export default function App(): JSX.Element {
    ...
    const journeyOptions = useMemo(
        () => [
            "all",
            ...journeyOrder.filter((journey) =>
                docs.some((doc) => doc.journey === journey),
            ),
        ],
        [],
    );
    ...
    const audienceOptions = useMemo(
        () => [
            ...
            ...audienceOrder.filter((audience) =>
                docs.some((doc) => doc.audience === audience),
            ),
        ],
        [],
    );
        ...
        () =>
            readingPaths.map((pathway) => {
                const total = docs.filter((doc) => {
                    if (
                        pathway.filters.journey &&
                        doc.journey !== pathway.filters.journey
                    ) {
                        return false;
                    }
                    if (
                        pathway.filters.audience &&
                        doc.audience !== pathway.filters.audience
                    ) {
                        return false;
                    }
                    if (
                        pathway.filters.kind &&
                        doc.kind !== pathway.filters.kind
                    ) {
                        return false;
                    }
                    if (
                        pathway.filters.section &&
                        doc.section !== pathway.filters.section
                    ) {
                        return false;
                    }
                    return true;
    ...
    const docsByPath = useMemo(
        () => new Map(docs.map((doc) => [doc.path, doc])),
        [],
    );
    ...
    const groupedDocs = useMemo(() => {
        ...
        return [...grouped.entries()]
            ...
            .sort((a, b) => {
                ...
                return groupLabel(groupBy, a[0], locale).localeCompare(
                    groupLabel(groupBy, b[0], locale),
                );
            });
    }, [filteredDocs, groupBy, locale]);

    const currentIndex = filteredDocs.findIndex(
        (doc) => doc.path === activePath,
    );
    const previousDoc =
        currentIndex > 0 ? filteredDocs[currentIndex - 1] : null;
    const nextDoc =
        ...
        <div className="zc-app">
            <header className="topbar">
                <div className="topbar-inner">
                    ...
                    <nav className="top-nav" aria-label="Primary">
                        ...
                        <a
                            href="https://github.com/deepakdgupta1/zeroclaw"
                            target="_blank"
                            rel="noreferrer"
                        >
                            {text.navGitHub}
            ...
            <main id="top">
                    ...
                    <div className="hero-inner">
                        <div className="hero-layout">
                            ...
                            <aside
                                ...
                                aria-label={text.commandLaneTitle}
                            >
                                <header>
                        ...
                        <section
                            ...
                            aria-label={text.engineeringTitle}
                        >
                ...
                <section id="docs-workspace" className="docs-shell">
                    ...
                    <section
                        className="pathway-shell"
                        aria-label={text.readingPathsTitle}
                    >
                        ...
                        <div className="pathway-grid">
                            {pathwayStats.map((pathway) => (
                                ...
                                >
                                    <span className="pathway-title">
                                        {pathway.label[locale]}
                                    </span>
                                    <span className="pathway-detail">
                                        {pathway.detail[locale]}
                                    </span>
                    ...
                    <section
                        ...
                        aria-label={text.startHereTitle}
                    >
                                ...
                                starterDocs.map((doc) => (
                                    ...
                                    >
                                        ...
                                        <span className="starter-meta">
                                            {formatJourney(doc.journey, locale)}{" "}
                                            · {doc.readingMinutes}
                                            {text.minuteUnit}
                                        </span>
                                    </button>
                    ...
                    <div className="docs-toolbar">
                        ...
                        <select
                            ...
                            onChange={(event) => {
                                setActivePathway(null);
                                setJourneyFilter(
                                    event.target.value as Journey | "all",
                                );
                            }}
                        ...
                        <select
                            ...
                            onChange={(event) => {
                                setActivePathway(null);
                                setAudienceFilter(
                                    event.target.value as Audience | "all",
                                );
                            }}
                        ...
                        <select
                            ...
                            onChange={(event) => {
                                setActivePathway(null);
                                setKindFilter(
                                    event.target.value as DocKind | "all",
                                );
                            }}
                        ...
                        <select
                            value={groupBy}
                            onChange={(event) =>
                                setGroupBy(event.target.value as GroupMode)
                            }
                    ...
                    <div className="workspace-grid">
                        ...
                        <section className="doc-reader" aria-live="polite">
                            ...
                            {loading ? (
                                <p className="reader-status">{text.loading}</p>
                            ) : null}

                            {!loading && error ? (
                                <p className="reader-status">
                                    {text.fallback}{" "}
                                    <a href={withRepo(activePath)}>
                                        {withRepo(activePath)}
                                    </a>
                                </p>
                            ) : null}
                            ...
                            {!loading && !error && markdown ? (
                                <article
                                    className={`markdown-body size-${readerScale} width-${readerWidth}`}
                                >
                                    <ReactMarkdown
                                        ...
                                        components={{
                                            ...
                                            a: ({ href, children }) => {
                                                ...
                                                if (docPath) {
                                                    ...
                                                    const hrefAnchor =
                                                        resolved.hash
                                                            ? `#${encodeURIComponent(resolved.hash)}`
                                                            : "";
                                                    return (
                                                        <a
                            ...
                            <footer className="reader-nav">
                                <button
                                    ...
                                    onClick={() =>
                                        previousDoc && openDoc(previousDoc.path)
                                    }
                                >
                                    {text.previousDoc}
                                </button>
            ...
            <footer className="footer">
                <p>
                    ZeroClaw · Trait-driven architecture · secure-by-default
                    runtime · pluggable everything
                </p>
            </footer>
